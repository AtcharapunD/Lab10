...
public Chap10_03(){
    ...
    String choices[] = { "Yak Ruw Tae Mai Yak Tham",
    "Taxi : Kid Tuang Chan Mai" , "Player Hurt"};
    ...
    public void playmusic(String musiclocation) {
        try {
            ...
            if (musicpatch.exists()) {
                AudioInputStream AudioIn = AudioSystem.getAudioInputStream(musicpatch);
                ...
                JOptionPane.showMessageDialog(null, "Please OK stop Playing");
